...
public function createCheckoutSession(Dons $don): Response
{
    ...
    #[Route('/donation', name: 'user_page_don')]
    public function addUSERPAGE(Request $request, EntityManagerInterface $entityManager): Response
    {
        $don = new Dons();
    $form = $this->createForm(DonsType::class, $don);
    $form->handleRequest($request);
    ...
    return $this->render('dons/user_page_don.html.twig', [
        'form' => $form->createView(),
    ]);
    }
